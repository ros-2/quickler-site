...
const clusters = {
  ...
  care: {
    ...
    pages: [
      ...
      ["care-inspectorate-wales-compliance-software", "CIW compliance (Wales)"],
      ["rqia-compliance-software-northern-ireland", "RQIA compliance (NI)"],
    ],
  },
  construction: {
  ...
  alternatives: {
    ...
    pages: [
      ...
      ["fleetping-alternative-uk", "FleetPing alternative"],
      ["popprobe-alternative-uk", "POPProbe alternative"],
      ["clue-alternative-uk", "Clue alternative"],
