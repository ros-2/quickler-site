...
await new Promise(r=>s.listen(4585,r));
...
await pg.goto("http://localhost:4585/pages/about.html",{waitUntil:"load"});
await pg.waitForTimeout(500);
// founder panel (block 1)
await pg.evaluate(()=>{const p=[...document.querySelectorAll('.story')][1];p.scrollIntoView();});
await pg.waitForTimeout(600);
await pg.screenshot({path:SC+"about-founder.png"});
